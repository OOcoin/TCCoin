...
/*           if (true && genesis.GetHash() != hashGenesisBlock) 
        ...
        assert(hashGenesisBlock == uint256("0x946e5e3f1cb70580f917f1a66df07a729e76ba84288f8952e6fa251ec81dc79c"));
		...
		vSeeds.push_back(CDNSSeedData("47.100.77.94", "47.100.77.94"));
		vSeeds.push_back(CDNSSeedData("47.100.77.38", "47.100.77.38"));
