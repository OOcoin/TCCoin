...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "TCChain.lnk";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("TCChain-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  TCChain-Qt [" + tr("command-line options") + "]                     " + "\n";
